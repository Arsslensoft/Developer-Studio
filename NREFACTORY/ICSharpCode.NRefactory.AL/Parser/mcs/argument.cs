	...
	public class Arguments
	{
		...
		public ArrayInitializer CreateDynamicBinderArguments (ResolveContext rc)
		{
			...
			foreach (Argument a in args) {
				...
				// ALArgumentInfoFlags.None = 0
				const string info_flags_enum = "ALArgumentInfoFlags";
				...
				all.Add (new Invocation (new MemberAccess (new MemberAccess (binder, "ALArgumentInfo", loc), "Create", loc), dargs));
			}
