...
namespace ALCompiler
{
	...
	public class Tokenizer : yyParser.yyInput
	{
		...
		static readonly NumberFormatInfo AL_format_info;
		...
		static Tokenizer ()
		{
			...
			AddKeyword ("mybase", Token.BASE);
			AddKeyword ("boolean", Token.BOOL);
			AddKeyword ("exit", Token.BREAK);
			AddKeyword ("byte", Token.BYTE);
			AddKeyword ("val", Token.CASE);
			AddKeyword ("catch", Token.CATCH);
			AddKeyword ("char", Token.CHAR);
			AddKeyword ("checked", Token.CHECKED);
			AddKeyword ("class", Token.CLASS);
			AddKeyword ("constant", Token.CONST);
			...
			AddKeyword ("real", Token.DOUBLE);
			AddKeyword ("else", Token.ELSE);
            AddKeyword("enumerator", Token.ENUM);
			AddKeyword ("event", Token.EVENT);
			AddKeyword ("explicit", Token.EXPLICIT);
            AddKeyword("external", Token.EXTERN);
            ...
            AddKeyword("integer", Token.INT);
			AddKeyword ("interface", Token.INTERFACE);
			AddKeyword ("internal", Token.INTERNAL);
			AddKeyword ("is", Token.IS);
            AddKeyword("secure", Token.LOCK);
            AddKeyword("longint", Token.LONG);
            AddKeyword("program", Token.NAMESPACE);
			AddKeyword ("new", Token.NEW);
            AddKeyword("nothing", Token.NULL);
			...
			AddKeyword ("backwith", Token.RETURN);
			AddKeyword ("sbyte", Token.SBYTE);
            AddKeyword("final", Token.SEALED);
            AddKeyword("put", Token.SET);
			AddKeyword ("shortint", Token.SHORT);
            ...
            AddKeyword("uinteger", Token.UINT);
			AddKeyword ("ulongint", Token.ULONG);
			AddKeyword ("unchecked", Token.UNCHECKED);
			AddKeyword ("unsafe", Token.UNSAFE);
			AddKeyword ("ushortint", Token.USHORT);
            AddKeyword("include", Token.USING);
			...
			AL_format_info = NumberFormatInfo.InvariantInfo;
		...
		ILiteralConstant adjust_real (TypeCode t, Location loc)
		{
			...
			case TypeCode.Decimal:
				try {
					return new DecimalLiteral (context.BuiltinTypes, decimal.Parse (s, styles, AL_format_info), loc);
				} catch (OverflowException) {
			...
			case TypeCode.Single:
				try {
					return new FloatLiteral (context.BuiltinTypes, float.Parse (s, styles, AL_format_info), loc);
				} catch (OverflowException) {
			...
			default:
				try {
					return new DoubleLiteral (context.BuiltinTypes, double.Parse (s, styles, AL_format_info), loc);
				} catch (OverflowException) {
					Report.Error (594, loc, error_details, "real");
