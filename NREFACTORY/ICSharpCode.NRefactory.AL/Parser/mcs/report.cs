...
*/
	...
	public abstract class ReportPrinter
	{
        ...
        {
            foreach (KeyValuePair<string, string> p in Keywords)
        ...
        public ReportPrinter()
        {
            ...
            Keywords.Add(" base ", "mybase");
            Keywords.Add(" this ", "self");
            Keywords.Add(" bool ", " boolean ");
            Keywords.Add(" break ", "exit");
            Keywords.Add(" return ", " backwith ");
            Keywords.Add(" namespace ", "program ");
            Keywords.Add(" null ", "nothing");
            Keywords.Add("using ", "include ");
            Keywords.Add(" void ", " sub ");
            Keywords.Add("{", "{");
            Keywords.Add("}", "}");
            Keywords.Add(" switch ", " change ");
            Keywords.Add(" case ", " state ");
            Keywords.Add(" const ", " constant ");
            Keywords.Add(" continue ", " persist ");
            Keywords.Add(" int ", " integer ");
            Keywords.Add(" long ", " longint ");
            Keywords.Add(" uint ", " uinteger ");
            Keywords.Add(" ulong ", " ulongint ");
            Keywords.Add(" short ", " shortint ");
            Keywords.Add(" ushort ", " ushortint ");
            Keywords.Add(" double ", " real ");
            Keywords.Add(" sealed ", " final ");
            Keywords.Add(" lock ", " secure ");
            Keywords.Add(" set ", " put ");
            Keywords.Add(" enum ", " enumerator ");
        }
		public void Reset ()
		{
