...
namespace ALCompiler
{
	...
	public class TypeSpec : MemberSpec
	{
		...
		protected virtual string GetTypeNameSignature ()
		{
			...
			return "<" + TypeManager.ALName (MemberDefinition.TypeParameters) + ">";
		}
	...
	public sealed class BuiltinTypeSpec : TypeSpec
	{
		...
		public override string GetSignatureForError ()
		{
            ...
            case "Int64": return "longint";
			case "String": return "string";
			case "Boolean": return "boolean";
            case "sub": return "sub";
			case "Object": return "object";
			case "UInt32": return "uinteger";
            case "Int16": return "shortint";
            case "UInt16": return "ushortint";
            case "UInt64": return "ulongint";
	...
	class InternalType : TypeSpec, ITypeDefinition
	{
        ...
        public static readonly InternalType NullLiteral = new InternalType("nothing");
