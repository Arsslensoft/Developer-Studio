...
namespace ALCompiler {
	...
	public class CommandLineParser
	{
		...
		void About ()
		{
            output.WriteLine("AL compiler 2.0 By Arsslensoft Labs" +
                "Copyright (c) 2014 Arsslensoft Labs. All rights reserved\n " +
                "Based on the Mono C# compiler : Copyright 2001-2011, Novell, Inc.");
            output.WriteLine("Thanks to : Miguel de Icaza, Ravi Pratap, Martin Baulig, Marek Safar, Raja R Harinath, Atushi Enomoto");
		...
		{
			output.WriteLine (
				"Arsslen Language compiler, Copyright 2010-2014 Arsslensoft\n" +
				"alc [options] source-files\n" +
				"   --about              About the Arsslen Language compiler\n" +
		...
		void Version ()
		{
			...
			output.WriteLine ("Arsslen Language compiler version {0}", version);
		}
	}
