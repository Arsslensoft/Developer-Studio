...
namespace ALCompiler
{
	...
	public class BuiltinTypes
	{
		...
		public BuiltinTypes ()
		{
			...
			Double = new BuiltinTypeSpec (MemberKind.Struct, "System", "real", BuiltinTypeSpec.Type.Double);
			...
			Enum = new BuiltinTypeSpec (MemberKind.Class, "System", "enumerator", BuiltinTypeSpec.Type.Enum);
			Array = new BuiltinTypeSpec (MemberKind.Class, "System", "Array", BuiltinTypeSpec.Type.Array);
			Void = new BuiltinTypeSpec (MemberKind.Void, "System", "sub", BuiltinTypeSpec.Type.Other);
	...
	class PredefinedTypes
	{
		...
		public PredefinedTypes (ModuleContainer module)
		{
			...
			Binder = new PredefinedType (module, MemberKind.Class, "Microsoft.AL.RuntimeBinder", "Binder");
			BinderFlags = new PredefinedType (module, MemberKind.Enum, "Microsoft.AL.RuntimeBinder", "ALBinderFlags");
	...
	static public string ALName(IList<TypeSpec> types)
	{
		if (types.Count == 0)
			return string.Empty;
	...
	static public string ALSignature (MemberSpec mb)
	{
