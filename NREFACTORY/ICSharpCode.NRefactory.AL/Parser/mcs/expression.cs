...
namespace ALCompiler
{
	...
	public class Unary : Expression
	{
		...
		{
			ALCompiler.Operator.OpType op_type;
			switch (Oper) {
			case Operator.LogicalNot:
				op_type = ALCompiler.Operator.OpType.LogicalNot; break;
			case Operator.OnesComplement:
				op_type = ALCompiler.Operator.OpType.OnesComplement; break;
			case Operator.UnaryNegation:
				op_type = ALCompiler.Operator.OpType.UnaryNegation; break;
			case Operator.UnaryPlus:
				op_type = ALCompiler.Operator.OpType.UnaryPlus; break;
			default:
	...
	public class Binary : Expression, IDynamicBinder
	{
		...
		static ALCompiler.Operator.OpType ConvertBinaryToUserOperator (Operator op)
		{
			switch (op) {
			case Operator.Addition:
                    return ALCompiler.Operator.OpType.Addition;
			case Operator.BitwiseAnd:
			case Operator.LogicalAnd:
                    return ALCompiler.Operator.OpType.BitwiseAnd;
			case Operator.BitwiseOr:
			case Operator.LogicalOr:
                    return ALCompiler.Operator.OpType.BitwiseOr;
			case Operator.Division:
                    return ALCompiler.Operator.OpType.Division;
			case Operator.Equality:
                    return ALCompiler.Operator.OpType.Equality;
			case Operator.ExclusiveOr:
                    return ALCompiler.Operator.OpType.ExclusiveOr;
			case Operator.GreaterThan:
                    return ALCompiler.Operator.OpType.GreaterThan;
			case Operator.GreaterThanOrEqual:
                    return ALCompiler.Operator.OpType.GreaterThanOrEqual;
			case Operator.Inequality:
				return ALCompiler.Operator.OpType.Inequality;
			case Operator.LeftShift:
				return ALCompiler.Operator.OpType.LeftShift;
			case Operator.LessThan:
				return ALCompiler.Operator.OpType.LessThan;
			case Operator.LessThanOrEqual:
				return ALCompiler.Operator.OpType.LessThanOrEqual;
			case Operator.Modulus:
				return ALCompiler.Operator.OpType.Modulus;
			case Operator.Multiply:
				return ALCompiler.Operator.OpType.Multiply;
			case Operator.RightShift:
				return ALCompiler.Operator.OpType.RightShift;
			case Operator.Subtraction:
				return ALCompiler.Operator.OpType.Subtraction;
			default:
		...
		Expression ResolveEquality (ResolveContext ec, TypeSpec l, TypeSpec r, bool primitives_only)
		{
			...
			if (l.BuiltinType == BuiltinTypeSpec.Type.String || l.BuiltinType == BuiltinTypeSpec.Type.Delegate || l.IsDelegate || MemberCache.GetUserOperator (l, ALCompiler.Operator.OpType.Equality, false) != null)
			...
			if (r.BuiltinType == BuiltinTypeSpec.Type.String || r.BuiltinType == BuiltinTypeSpec.Type.Delegate || r.IsDelegate || MemberCache.GetUserOperator (r, ALCompiler.Operator.OpType.Equality, false) != null)
		...
		public Expression CreateCallSiteBinder (ResolveContext ec, Arguments args)
		{
			...
			ALBinderFlags flags = 0;
			if (ec.HasSet (ResolveContext.Options.CheckedScope))
				flags = ALBinderFlags.CheckedContext;

			if ((oper & Operator.LogicalMask) != 0)
				flags |= ALBinderFlags.BinaryOperationLogical;
	...
	public class UserCast : Expression {
		...
		public override string GetSignatureForError ()
		{
			return TypeManager.ALSignature (method);
		}
