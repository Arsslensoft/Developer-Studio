...
{
  public  class PascalCompletionManager
    {
      public string SourceFile { get; set; }
      public CompletionWindow completionWindow { get; set; }
      internal PasCodeCompletionProvider completion { get; set; }
      public PascalCompletionManager()
      {
          completion = new PasCodeCompletionProvider();
      }
      ...
      public void TextEntered(object sender, TextCompositionEventArgs e, TextEditor editor)
      {
          try
          {
              if (completionWindow == null)
              {
                      ...
                      if (line.ToLower().StartsWith("uses"))
                      {
