...
namespace ICSharpCode.CodeCompletion
{
    sealed class CSharpCompletionDataFactory : ICompletionDataFactory, IParameterCompletionDataFactory
    {
        ...
        public CSharpCompletionDataFactory(ALTypeResolveContext contextAtCaret, CSharpCompletionContext context)
        {
        ...
        {
            return new CompletionData(currentType.Name+"_"+varName);
        }
