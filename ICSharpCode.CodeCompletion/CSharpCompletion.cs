...
namespace ICSharpCode.CodeCompletion
{
    public class CSharpCompletion
    {
        ...
        {
            projectContent = new ALProjectContent();
...
//					typeof(System.Drawing.Bitmap).Assembly, // System.Drawing.dll
                typeof(System.Windows.Forms.Form).Assembly, // System.Windows.Forms.dll
//					typeof(ICSharpCode.NRefactory.TypeSystem.IProjectContent).Assembly,
        ...
        public void ProcessInput(string input, string sourceFile)
        {
            ...
            if (input.Contains("class ") || input.Contains("enumerator ") || input.Contains("struct "))
            {
                var syntaxTree = new ALParser().Parse(input, sourceFile);
                syntaxTree.Freeze();
        ...
        public CodeCompletionResult GetCompletions(IDocument document, int offset, bool controlSpace, string usings)
        {
            ...
            var cce = new ALCompletionEngine(
