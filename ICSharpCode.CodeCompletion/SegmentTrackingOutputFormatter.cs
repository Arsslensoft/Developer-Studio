...
namespace ICSharpCode.CodeCompletion
{
    ...
    /// </summary>
    public class SegmentTrackingOutputFormatter : ICSharpCode.NRefactory.AL.TextWriterTokenWriter
    {
        ...
        public static IDictionary<AstNode, ISegment> WriteNode(StringWriter writer, AstNode node, ALFormattingOptions policy, ICSharpCode.AvalonEdit.TextEditorOptions options)
        {
